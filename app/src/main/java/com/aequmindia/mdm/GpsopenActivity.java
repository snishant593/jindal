 ...
 */
public class GpsopenActivity extends AppCompatActivity implements OnCompleteListener<Void>,ForceUpdateChecker.OnUpdateNeededListener{
    ...
    DBHelper mydb = new DBHelper( GpsopenActivity .this);
...
//    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gpsopen);
...
//                Manifest.permission.SEND_SMS);
            ...
            showSnackbar(R.string.permission_rationale, android.R.string.ok,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions( GpsopenActivity .this,
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_PERMISSIONS_REQUEST_CODE) {
            ...
            {
                Toast.makeText( GpsopenActivity .this,"permission granted", Toast.LENGTH_SHORT).show();
...

                        {
...

                            {
                                ...
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        status.startResolutionForResult( GpsopenActivity .this, 1000);
    ...
    private void requestCameraPermission() {
        ...
        ActivityCompat.requestPermissions( GpsopenActivity .this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE},
                0);
...
//        startActivity(intent);
        if (ActivityCompat.checkSelfPermission( GpsopenActivity .this,Manifest.permission.WRITE_EXTERNAL_STORAGE)
...
*/
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                Uri apkUri = FileProvider.getUriForFile( GpsopenActivity .this, BuildConfig.APPLICATION_ID + ".provider", (new File(toInstall+"/jindal.apk")));
                Intent intent = new Intent(Intent.ACTION_INSTALL_PACKAGE);
                intent.setData(apkUri);
                intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                // intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                GpsopenActivity .this.startActivity(intent);
            } else {
